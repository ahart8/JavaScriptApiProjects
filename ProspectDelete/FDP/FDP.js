...
const dbid = 'ahartfdp'; //Company code to make this more reusable.
...
*/
const token = '32WRPux_7HDh7XAjY9gfFEb2hH240CM2lwpfI8fz_dBnraWbHGhn3y3gReMIxZCfzTtr46VZVPPIePVG7s3koO5ooGSEAS_BpFafcV_y46s='; 
...
async function main(){
    ...
    for (n in prospectIds){
        ...
        */
        ...
        let url = `https://${dbid}.api.rentmanager.qa/Prospects?ids=${prospectIds[n]}`; 
        ...
        try{
            ...
            console.log(`${prospectIds[n]} WAS A SUCCESS`);
